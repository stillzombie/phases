@section('submenu')
<a href="{{url('phase')}}" class="border-b-2 border-transparent hover:border-blue-200 flex items-center">
  ...
  <div>
    ...
    <div class="hidden sm:block">
      <nav class="flex -mb-px">
        ...
        <div  wire:click="activeFilter('close')" >
          <x-tab-item filter="close" :active='$filter=="close"' >
            <x-heroicon-s-ban class="-ml-0.5 mr-2 h-5 w-5"/>
            <span>Close</span>
          </x-tab-item>
        </div>
      </nav>
