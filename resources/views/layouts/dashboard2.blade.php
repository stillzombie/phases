...
>
  <div class="bg-black pb-32">
    <nav x-data="{ open: false }" @keydown.window.escape="open = false" class="bg-black">
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="border-b border-gray-700">
          <div class="flex items-center justify-between h-16 px-4 sm:px-0">
            <div class="flex items-center">
              <div class="flex-shrink-0">
                <svg xmlns="http://www.w3.org/2000/svg" width="40.0" height="38.935" viewBox="0 0 40.0 38.935"><defs><style>.a{fill:#fff;}</style></defs><g transform="translate(-11.505 -11.485)"><path class="a" d="M47.412,20.484,46.064,23.5a16.818,16.818,0,0,1-22.21,22.692L41.542,21.315,43.88,23.65l4.5-10.1h0l-10.1,4.509,2.339,2.334L15.741,38.081A16.822,16.822,0,0,1,38.42,15.867l3.015-1.348A19.488,19.488,0,0,0,15.1,42.25l1.684-1.417h0l24.867-20.9L16.421,43.865l.823.823.823.823L42,20.282l-.68.81h0L21.145,45.1l-1.46,1.723A19.483,19.483,0,0,0,47.412,20.484Z" transform="translate(0 0)"/></g></svg>
              </div>
              <div class="hidden md:block">
                <div class="ml-10 flex items-baseline">
                  <x-menu-item key="projects"  >Projects</x-menu-item>
                  <x-menu-item key="phases">Phases</x-menu-item>
                  <x-menu-item key="livetrack">Live Track</x-menu-item>
                  <x-menu-item key="tracked">Tracked</x-menu-item>
                </div>
              </div>
            </div>
            <div class="hidden md:block">
                ...
                <div @click.away="open = false" class="ml-3 relative" x-data="{ open: false }">
                  <div>
                    <button @click="open = !open" class="max-w-xs flex items-center text-sm rounded-full text-white focus:outline-none focus:shadow-solid" id="user-menu" aria-label="User menu" aria-haspopup="true" x-bind:aria-expanded="open">
                      <img class="h-8 w-8 rounded-full" src="{{ asset('img/b.png') }}" alt="" />
                    </button>
                  </div>
    ...
    <header class="py-10">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
       ...
       <x-hx value="2" class="text-coral-200 lowercase">
         {{$title}}
       </x-hx>
       ...
       <x-hx value="3" class="text-melanzani-200">
        ...
        <div class="mt-2 flex items-center text-sm leading-5 text-blue-200 sm:mr-6">
          @yield('submenu')
        </div>
      </div>
    </header>
